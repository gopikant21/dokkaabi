      ...
      <div className="flex items-center">
        ...
        <div className="relative ml-2">
          ...
          <input
            ...
            className="bg-dashboard-card-bg border border-dashboard-border rounded-md pl-10 pr-4 py-2 w-80 focus:outline-none focus:ring-2 focus:ring-dashboard-accent-purple/40 text-sm"
          />
        </div>
      </div>
