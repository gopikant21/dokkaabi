    ...
    <div className="bg-dashboard-card-bg rounded-lg overflow-hidden border border-dashboard-border">
      ...
      <table className="w-full">
        <thead className="bg-dashboard-dark-bg">
          <tr>
            <th className="text-left py-3 px-4 text-xs text-dashboard-text-secondary uppercase font-medium">Candidate Name</th>
            <th className="text-left py-3 px-4 text-xs text-dashboard-text-secondary uppercase font-medium">Rating</th>
            <th className="text-left py-3 px-4 text-xs text-dashboard-text-secondary uppercase font-medium">Stages</th>
            <th className="text-left py-3 px-4 text-xs text-dashboard-text-secondary uppercase font-medium">Applied Role</th>
            <th className="text-left py-3 px-4 text-xs text-dashboard-text-secondary uppercase font-medium">Application Date</th>
            <th className="text-left py-3 px-4 text-xs text-dashboard-text-secondary uppercase font-medium">Attachments</th>
          </tr>
        </thead>
        <tbody>
            ...
            >
              ...
              <td className="py-4 px-4">
                <div className="flex items-center space-x-1">
                  <File size={14} />
                  <span>{candidate.attachments} {candidate.attachments === 1 ? 'file' : 'files'}</span>
                </div>
              </td>
            </tr>
          ))}
